...
**Booser.AsyncCompression** — это консольное приложение для асинхронного сжатия файлов, построенное с использованием принципов **Domain-Driven Design (DDD)** и **SOLID**. Проект демонстрирует современные подходы к архитектуре .NET приложений с применением паттернов проектирования и dependency injection - слава AI! :).
