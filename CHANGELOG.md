...
### Добавлено
- **Поддержка сжатия папок** с рекурсивной обработкой
- **DirectoryCompressionResult** и **FileCompressionSummary** для агрегации результатов
- **Поддержка CLI** для указания директории вместо файла
- **Интеграционные тесты** для проверки сжатия каталогов

### Изменено
- Обновлена документация (README, VERSIONING, GITHUB_ISSUES_PRIORITY)
- Версия проекта повышена до `2.0.0`
