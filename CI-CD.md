...
- **Действия**:
  - Автоматическое определение типа версии из сообщений коммитов
  - Увеличение версии в `.csproj` файле (major/minor/patch)
  - Создание NuGet пакета с новой версией
  - Публикация в NuGet (если настроен API ключ)
  - Коммит изменений версии обратно в репозиторий
  - Создание GitHub Release с тегом новой версии

#### Автоматическое версионирование
Версия автоматически увеличивается на основе типа коммита:
- **Major** (X.0.0): при наличии `breaking`, `major`, `BREAKING` в сообщении
- **Minor** (0.X.0): при наличии `feat:` или `feature:` в сообщении  
- **Patch** (0.0.X): по умолчанию для `fix:`, `refactor:`, `docs:`, `test:`, `chore:`

Подробнее см. [VERSIONING.md](VERSIONING.md)
